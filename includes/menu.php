  ...
  <header class="header-bar d-flex d-lg-block align-items-center" data-aos="fade-left">
    ...
    <div class="main-menu">
      <ul class="js-clone-nav">
        <li class="active"><a href="/galeria/index.php">Inicio</a></li>
        <li class="active"><a href="/galeria/home.php?page=listado">Listado</a></li>
        <li class="active"><a href="/galeria/home.php?page=autores">Autores</a></li>
        <li class="active"><a href="/galeria/home.php?page=new">Añadir Foto</a></li>
